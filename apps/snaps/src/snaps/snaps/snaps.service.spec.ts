...
describe('SnapsService', () => {
    ...
    describe('onModuleInit', () => {
        it('should initialize grpc services', () => {
            ...
            expect(storageClient.getService).toHaveBeenCalledWith(AWS_STORAGE_SERVICE_NAME);
        });
    });
    ...
    describe('create', () => {
        it('should create a snap successfully', async () => {
            ...
            expect(redisClient.emit).toHaveBeenCalledWith('upload-snap', expect.anything());
        ...
        it('should throw ForbiddenException if user already posted', async () => {
            ...
            await expect(service.create('u1', [], createDto)).rejects.toThrow(ForbiddenException);
        });
    });
    ...
    describe('handleCreateSnap', () => {
        it('should handle error and delete snap', async () => {
            ...
            await expect(service.handleCreateSnap(data)).rejects.toThrow(BadRequestException);
