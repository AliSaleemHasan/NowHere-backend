...
describe('SnapsGetaway', () => {
    let gateway: SnapsGetaway;
    let serverMock: any;
    ...
    beforeEach(async () => {
        ...
        const module: TestingModule = await Test.createTestingModule({
            providers: [SnapsGetaway],
        }).compile();

        gateway = module.get<SnapsGetaway>(SnapsGetaway);
    ...
    describe('handleDisconnect', () => {
        it('should remove client from map', () => {
            ...
            gateway.usersLocationMap.set('c1', { socketId: 'c1', coordinates: [0, 0] });
    ...
    describe('findNearbyUsers', () => {
        it('should find users within radius', () => {
            gateway.usersLocationMap.set('u1', { socketId: 'u1', coordinates: [0, 0] }); // center
            gateway.usersLocationMap.set('u2', { socketId: 'u2', coordinates: [0.001, 0.001] }); // very close
            gateway.usersLocationMap.set('u3', { socketId: 'u3', coordinates: [10, 10] }); // far away
    ...
    describe('handleNewSnap', () => {
        it('should emit snap-added to nearby users', () => {
            gateway.usersLocationMap.set('u1', { socketId: 'u1', coordinates: [0, 0] });
